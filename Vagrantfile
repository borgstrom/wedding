...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.hostname = "wedding-#{CURRENT_USER}"
  ...
  config.vm.synced_folder ".", "/home/vagrant/domains/wedding",
    owner: "vagrant",
    group: "vagrant",
  ...
  config.vm.provision :shell,
    inline: "echo; echo; echo \"Your development environment is now configured\"; echo \"You can access it at http://wedding-#{CURRENT_USER}.local/\"; echo"
end